...
raw_data_url = "https://raw.githubusercontent.com/learning-things-123/reimagined-octo-bassoon/main/lightbeamData.json"
...
def loadData():
    with urllib.request.urlopen(raw_data_url) as url:
